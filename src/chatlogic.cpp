...
ChatLogic::ChatLogic()
{
   /*we will create smart pointer instead of new so we will n't use new*/
}

ChatLogic::~ChatLogic()
{
   /*Nothing to do as the unique pointer will be auto deleted*/
}
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            /*replace the new with unique smart poniter */
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            /* not needed any more after change the edge to smart pointer*/
