...
ChatBot::ChatBot(const ChatBot& Input)
{
    ...
    _chatLogic = Input._chatLogic;
    _rootNode = Input._rootNode;
    _currentNode = Input._currentNode;
    /* load image into heap memory*/
    _image = new wxBitmap(*(Input._image));
}

/* R2--> assignment operator */ 
